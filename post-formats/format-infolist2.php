...
$tmp .= '<span class="date new">'. $mod_date .'</span><br>';
...
the_posts_pagination(
    array(
        ...
        'prev_next'     => true, // 「前へ」「次へ」のリンクを表示する場合はtrue
				'prev_text'     => '<img src="'.get_template_directory_uri().'/images/royalcanin/icon_arrow.png" width="8">', // 「前へ」リンクのテキスト
				'next_text'     => '<img src="'.get_template_directory_uri().'/images/royalcanin/icon_arrow_r.png" width="8">', // 「次へ」リンクのテキスト
